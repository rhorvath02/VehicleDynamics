...
Modelica.Mechanics.MultiBody.Joints.Prismatic free_x(n = {1, 0, 0}, useAxisFlange = true)  annotation(
  ...
  Modelica.Blocks.Sources.Constant vel_source(k = 1)  annotation(
    Placement(transformation(origin = {-90, -62}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
...
equation
  ...
  connect(vel_source.y, v_x.v_ref) annotation(
    Line(points = {{-78, -62}, {-62, -62}}, color = {0, 0, 127}));
  connect(v_x.flange, free_x.axis) annotation(
    Line(points = {{-40, -62}, {-26, -62}}, color = {0, 127, 0}));
  connect(body.frame_a, baseMF52.corner_frame) annotation(
