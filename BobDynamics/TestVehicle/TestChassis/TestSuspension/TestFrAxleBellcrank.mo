...
model TestFrAxleBellcrank
  ...
  Modelica.Mechanics.MultiBody.Parts.Fixed FL_fixed(r = {0, 0.609600, -1.5*0.0254*0})  annotation(
    Placement(transformation(origin = {-78, -30}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.Fixed FR_fixed(r = {0, -0.609600, -1.5*0.0254*0})  annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp1(duration = 1, height = 1.25*0.0254, startTime = 1) annotation(
