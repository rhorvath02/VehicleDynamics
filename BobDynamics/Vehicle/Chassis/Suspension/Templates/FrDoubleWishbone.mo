...
// Wishbones
  BobDynamics.Vehicle.Chassis.Suspension.Linkages.Wishbone upper_wishbone(fore_i = upper_fore_i, aft_i = upper_aft_i, outboard = upper_o, link_diameter = link_diameter, joint_diameter = joint_diameter, fore_i_c = FUCA_fore_i_c, aft_i_c = FUCA_aft_i_c, fore_i_d = FUCA_fore_i_d, aft_i_d = FUCA_aft_i_d) annotation(
    Placement(transformation(origin = {50, 60}, extent = {{-10, -10}, {10, 10}})));
  BobDynamics.Vehicle.Chassis.Suspension.Linkages.Wishbone lower_wishbone(aft_i = lower_aft_i, fore_i = lower_fore_i, outboard = lower_o, link_diameter = link_diameter, joint_diameter = joint_diameter, fore_i_c = FLCA_fore_i_c, aft_i_c = FLCA_aft_i_c, fore_i_d = FLCA_fore_i_d, aft_i_d = FLCA_aft_i_d) annotation(
  ...
  // Tie rod
  BobDynamics.Vehicle.Chassis.Suspension.Linkages.Link link(inboard = tie_i, outboard = tie_o, link_diameter = link_diameter, joint_diameter = joint_diameter, inboard_c = tie_i_c, inboard_d = tie_i_d) annotation(
