...
partial model FrRigidAxleBase
  ...
  BobDynamics.Vehicle.Chassis.Suspension.Templates.FrRigidDoubleWishbone FL_double_wishbone annotation(
    Placement(transformation(origin = {-70, -50}, extent = {{-30, -30}, {30, 30}})));
  BobDynamics.Vehicle.Chassis.Suspension.Templates.FrRigidDoubleWishbone FR_double_wishbone(upper_fore_i = FR_upper_fore_i,
