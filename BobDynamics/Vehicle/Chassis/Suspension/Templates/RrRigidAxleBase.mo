...
partial model RrRigidAxleBase
  ...
  BobDynamics.Vehicle.Chassis.Suspension.Templates.RrRigidDoubleWishbone RL_double_wishbone annotation(
    Placement(transformation(origin = {-70, -50}, extent = {{-30, -30}, {30, 30}})));
  BobDynamics.Vehicle.Chassis.Suspension.Templates.RrRigidDoubleWishbone RR_double_wishbone(upper_fore_i = RR_upper_fore_i,
