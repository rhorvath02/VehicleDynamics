...
model RrAxleDWPullBCARB
  ...
  final parameter BobDynamics.Resources.Records.SUS.RrAxleDW RrAxle;
  final parameter BobDynamics.Resources.Records.SUS.RrAxleDWPullBCARB RrAxleBC;
  ...
  final parameter BobDynamics.Resources.Records.TIRES.Rr_tire Rr_tire;

  extends BobDynamics.Vehicle.Chassis.Suspension.Templates.AxleDoubleWishboneBase(left_upper_fore_i = RrAxle.upper_fore_i,
  ...
  final BobDynamics.Vehicle.Chassis.Suspension.Linkages.TabularSpring RL_tabular_spring(spring_table = RrAxle.spring_table,
                                                                                            free_length = RrAxle.free_length,
                                                                                            spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {50, 70}, extent = {{-10, -10}, {10, 10}})));
  final BobDynamics.Vehicle.Chassis.Suspension.Linkages.TabularDamper RL_tabular_damper(damper_table = [0, 0; 1, 1e3],
  ...
  final Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_shock_pickup(r = {RL_shock_mount[1], -RL_shock_mount[2], RL_shock_mount[3]} - effective_center) annotation(
    Placement(transformation(origin = {20, 70}, extent = {{-10, -10}, {10, 10}})));
  final BobDynamics.Vehicle.Chassis.Suspension.Linkages.TabularSpring RR_tabular_spring(spring_table = RrAxle.spring_table,
                                                                                        free_length = RrAxle.free_length,
                                                                                        spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {-50, 70}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  final BobDynamics.Vehicle.Chassis.Suspension.Linkages.TabularDamper RR_tabular_damper(damper_table = RrAxle.damper_table,
                                                                                        inner_diameter = 0.004,
                                                                                        outer_diameter = 0.008) annotation(
