...
//  final parameter Real upper_fore_i[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.upper.fore_i", 3);
//  final parameter Real upper_aft_i[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.upper.aft_i", 3);
//  final parameter Real lower_fore_i[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.lower.fore_i", 3);
//  final parameter Real lower_aft_i[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.lower.aft_i", 3);
//  final parameter Real upper_o[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.upper.outboard", 3);
//  final parameter Real lower_o[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.lower.outboard", 3);
//  final parameter Real tie_i[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.tie.inboard", 3);
//  final parameter Real tie_o[3](each fixed=true) = hdpts.getRealArray1D("Hardpoints.Front.left.tie.outboard", 3);

  final parameter Real upper_fore_i[3](each fixed=true) = {0.086868, 0.215900, 0.200000};
  final parameter Real upper_aft_i[3](each fixed=true) = {-0.095250, 0.215900, 0.200000};
  final parameter Real lower_fore_i[3](each fixed=true) = {0.087376, 0.215900, 0.090000};
  final parameter Real lower_aft_i[3](each fixed=true) = {-0.095250, 0.215900, 0.090000};
  final parameter Real upper_o[3](each fixed=true) = {-0.006347, 0.523240, 0.287020};
  final parameter Real lower_o[3](each fixed=true) = {0, 0.556499, 0.124998};
  final parameter Real tie_i[3](each fixed=true) = {0.041128, 0.215900, 0.117856};
  final parameter Real tie_o[3](each fixed=true) = {0.056000, 0.532333, 0.164821};
...
equation
  ...
  connect(link.frame_a, fixed12.frame_b) annotation(
    Line(points = {{0, 0}, {10, 0}}, color = {95, 95, 95}));
  connect(body.frame_a, wishbone1.outboard_frame) annotation(
