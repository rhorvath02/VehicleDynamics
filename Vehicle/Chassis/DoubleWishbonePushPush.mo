...
model DoubleWishbonePushPush
  ...
  final parameter Real upper_aft_i[3] = hdpts.getRealArray1D("Hardpoints.Front.left.upper.aft_i", 3);
  final parameter Real lower_fore_i[3] = hdpts.getRealArray1D("Hardpoints.Front.left.lower.fore_i", 3);
  final parameter Real lower_aft_i[3] = hdpts.getRealArray1D("Hardpoints.Front.left.lower.aft_i", 3);
  final parameter Real upper_o[3] = hdpts.getRealArray1D("Hardpoints.Front.left.upper.outboard", 3);
