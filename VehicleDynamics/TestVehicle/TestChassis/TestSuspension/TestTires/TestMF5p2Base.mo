...
model TestMF5p2Base
  ...
  Modelica.Mechanics.MultiBody.Joints.Prismatic free_x(n = {1, 0, 0}, useAxisFlange = false, boxWidth = 0.005, boxHeight = 0.005, animation = false, v(start = 5, fixed = true)) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp(height = 0, duration = 0, offset = 0, startTime = 0) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp1(height = -359*Modelica.Constants.pi/180, duration = 2, startTime = 0) annotation(
...
equation
  ...
  connect(ramp.y, MF5p2Base.u) annotation(
    Line(points = {{1, 30}, {19, 30}}, color = {0, 0, 127}));
  ...
  connect(free_y.frame_b, revolute.frame_a) annotation(
    Line(points = {{30, -20}, {30, -10}}, color = {95, 95, 95}));
