...
model TestFrRigidDoubleWishbone
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.FrRigidDoubleWishbone FrDoubleWishboneBase annotation(
...
protected
  ...
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire mF5p2Tire annotation(
    Placement(transformation(origin = {-90, 0}, extent = {{10, -10}, {-10, 10}})));
  ...
  __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian --maxSizeLinearization=5000");
