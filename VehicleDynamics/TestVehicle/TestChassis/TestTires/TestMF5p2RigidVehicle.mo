...
protected
  // System inputs
  Modelica.Blocks.Sources.Ramp rack_disp(height = 15*Modelica.Constants.pi/180, duration = 0.5, startTime = 2)  annotation(
  ...
  Modelica.Blocks.Sources.Ramp RL_torque(height = 50, duration = 1, startTime = 1)  annotation(
...
equation
  ...
  connect(RL_torque.y, RL_tire.hub_torque) annotation(
    Line(points = {{-79, 10}, {-52.5, 10}, {-52.5, -8}, {-52, -8}}, color = {0, 0, 127}));
  connect(RR_torque.y, RR_tire.hub_torque) annotation(
