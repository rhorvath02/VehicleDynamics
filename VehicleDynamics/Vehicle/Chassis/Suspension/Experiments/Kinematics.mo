...
model Kinematics
  ...
  parameter SIunits.Position upper_fore_i[3] = {0.086868, 0.215900, 0.200000} annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position upper_aft_i[3] = {-0.095250, 0.215900, 0.200000} annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position upper_o[3] = {-0.006347, 0.523240, 0.287020} annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position tie_i[3] = {0.041128, 0.215900, 0.117856} annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position tie_o[3] = {0.056000, 0.532333, 0.164821} annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position lower_fore_i[3] = {0.087376, 0.215900, 0.090000} annotation(
    Dialog(group = "Geometry"));
  ...
  Modelica.Blocks.Sources.Ramp ramp(height = 0.625*0.0254, duration = 1, startTime = 1) annotation(
