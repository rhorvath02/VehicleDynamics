...
equation
  ...
  connect(groundPhysics111.frame_a, MF5p2Base.frame_a) annotation(
    Line(points = {{-50, 0}, {-50, -10}, {-30, -10}, {-30, 20}}, color = {95, 95, 95}));
  connect(groundPhysics11.frame_a, MF5p2Base1.frame_a) annotation(
    Line(points = {{250, 0}, {250, -10}, {230, -10}, {230, 20}}, color = {95, 95, 95}));
  annotation(
