...
model Kinematics3
  ...
  parameter SIunits.Position contact_patch[3] = {6.21, 575.67, 0} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position upper_fore_i[3] = {105.56, 254, 198.73} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position upper_aft_i[3] = {-128.90, 254, 160.71} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position upper_o[3] = {-2.84, 541.94, 294.34} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position tie_i[3] = {56.9, 212.48, 86.36} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position tie_o[3] = {56.61, 547.29, 136.83} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position lower_fore_i[3] = {105.56, 190.5, 57.15} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position lower_aft_i[3] = {-128.9, 190.5, 57.15} / 1000 annotation(
    Dialog(group = "Geometry"));
  parameter SIunits.Position lower_o[3] = {2.7, 562.59, 114.13} / 1000 annotation(
  ...
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed(r = upper_fore_i) annotation(
    Placement(transformation(origin = {70, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed1(r = upper_aft_i) annotation(
    Placement(transformation(origin = {70, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed2(r = lower_fore_i) annotation(
    Placement(transformation(origin = {70, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed3(r = lower_aft_i) annotation(
    Placement(transformation(origin = {70, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed4(r = tie_i) annotation(
    Placement(transformation(origin = {70, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  ...
  Modelica.Blocks.Sources.Ramp ramp(height = 0.5875*0.0254, duration = 1, startTime = 1) annotation(
    Placement(transformation(origin = {-50, -60}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed5(r = contact_patch) annotation(
  ...
  Utilities.Mechanics.Multibody.GroundPhysics groundPhysics annotation(
    Placement(transformation(origin = {-100, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed6(r = {upper_fore_i[1], -upper_fore_i[2], upper_fore_i[3]}) annotation(
    Placement(transformation(origin = {130, 80}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed11(r = {upper_aft_i[1], -upper_aft_i[2], upper_aft_i[3]}) annotation(
    Placement(transformation(origin = {130, 40}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed21(r = {lower_fore_i[1], -lower_fore_i[2], lower_fore_i[3]}) annotation(
    Placement(transformation(origin = {130, 0}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed31(r = {lower_aft_i[1], -lower_aft_i[2], lower_aft_i[3]}) annotation(
    Placement(transformation(origin = {130, -40}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed41(r = {tie_i[1], -tie_i[2], tie_i[3]}) annotation(
    Placement(transformation(origin = {130, -80}, extent = {{10, -10}, {-10, 10}}, rotation = -180)));
  ...
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed51(r = {contact_patch[1], -contact_patch[2], contact_patch[3]}) annotation(
  ...
  Utilities.Mechanics.Multibody.GroundPhysics groundPhysics1 annotation(
    Placement(transformation(origin = {300, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body(r_CM = {0, 0, 0}, m = 8)  annotation(
    Placement(transformation(origin = {-30, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Mechanics.MultiBody.Parts.Body body1(m = 8, r_CM = {0, 0, 0}) annotation(
    Placement(transformation(origin = {230, 59}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  ...
  connect(groundPhysics.frame_b, MF5p2Base.frame_a) annotation(
    Line(points = {{-100, 0}, {-100, -10}, {-30, -10}, {-30, 20}}, color = {95, 95, 95}));
  ...
  connect(groundPhysics1.frame_b, MF5p2Base1.frame_a) annotation(
    Line(points = {{300, 0}, {300, -10}, {230, -10}, {230, 20}}, color = {95, 95, 95}));
  ...
  connect(fixed5.frame_b, groundPhysics.frame_a) annotation(
    Line(points = {{-80, 30}, {-80, 24}, {-100, 24}, {-100, 20}}, color = {95, 95, 95}));
  connect(fixed51.frame_b, groundPhysics1.frame_a) annotation(
    Line(points = {{280, 30}, {280, 24}, {300, 24}, {300, 20}}, color = {95, 95, 95}));
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-140, 100}, {320, -160}})));
end Kinematics3;
