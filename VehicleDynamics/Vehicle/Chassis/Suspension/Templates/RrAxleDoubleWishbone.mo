...
model RrAxleDoubleWishbone
  ...
  parameter VehicleDynamics.Resources.Records.TIRES.MF52_Tire Rr_tire;
  ...
  // RL apex geometry
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RL_apex(r = RL_UCA_mount - left_upper_o,
                                                              final length = norm(RL_UCA_mount - left_upper_o),
  ...
  // RL bellcrank
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RL_bellcrank_mount(r = RL_bellcrank_pivot - effective_center,
                                                                         final extra = 0.0) annotation(
  ...
  // RL shock
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RL_shock_pickup(r = RL_shock_mount - effective_center,
                                                                      final extra = 0.0) annotation(
    Placement(transformation(origin = {-20, 70}, extent = {{10, -10}, {-10, 10}})));
  Linkages.TabularSpring tabularSpring(final spring_table = [0, 0; 1, 70000],
                                       final free_length = 10*0.0254,
                                       final spring_diameter = 0.050) annotation(
    Placement(transformation(origin = {50, 70}, extent = {{-10, -10}, {10, 10}})));
  Linkages.TabularDamper tabularDamper(final damper_table = [0, 0; 1, 1e3],
                                       final inner_diameter = 0.004,
                                       final outer_diameter = 0.008) annotation(
    Placement(transformation(origin = {-50, 130}, extent = {{10, -10}, {-10, 10}})));
  
  // RR apex geometry
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_apex(r = {RL_UCA_mount[1], -RL_UCA_mount[2], RL_UCA_mount[3]} - right_upper_o,
                                                              final length = norm({RL_UCA_mount[1], -RL_UCA_mount[2], RL_UCA_mount[3]} - right_upper_o),
                                                              final extra = 0.0) annotation(
    Placement(transformation(origin = {110, 10}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  ...
  // RR bellcrank
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_bellcrank_mount(r = {RL_bellcrank_pivot[1], -RL_bellcrank_pivot[2], RL_bellcrank_pivot[3]} - effective_center,
                                                                         final extra = 0.0) annotation(
    Placement(transformation(origin = {30, 40}, extent = {{-10, -10}, {10, 10}})));
  ...
  // RR shock
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_shock_pickup(r = {RL_shock_mount[1], -RL_shock_mount[2], RL_shock_mount[3]} - effective_center,
                                                                      final extra = 0.0) annotation(
    Placement(transformation(origin = {20, 70}, extent = {{-10, -10}, {10, 10}})));
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Linkages.TabularDamper tabularDamper1(final damper_table = [0, 0; 1, 1e3],
                                                                                   final inner_diameter = 0.004,
                                                                                   final outer_diameter = 0.008) annotation(
