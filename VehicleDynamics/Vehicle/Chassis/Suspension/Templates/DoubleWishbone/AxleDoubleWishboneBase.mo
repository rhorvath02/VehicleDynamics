...
partial model AxleDoubleWishboneBase
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.DoubleWishbone.LeftDoubleWishbone left_double_wishbone(upper_fore_i = left_upper_fore_i,
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.DoubleWishbone.RightDoubleWishbone right_double_wishbone(upper_fore_i = right_upper_fore_i,
  ...
  // Tires
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire left_tire annotation(
    Placement(transformation(origin = {-130, -50}, extent = {{10, -10}, {-10, 10}})));
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire right_tire annotation(
    Placement(transformation(origin = {130, -50}, extent = {{-10, -10}, {10, 10}})));
