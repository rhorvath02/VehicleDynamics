...
partial model RrRigidAxleBase
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.RrRigidDoubleWishbone RL_double_wishbone annotation(
    Placement(transformation(origin = {-70, -50}, extent = {{-30, -30}, {30, 30}})));
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.RrRigidDoubleWishbone RR_double_wishbone(upper_fore_i = RR_upper_fore_i,
                                                                                                upper_aft_i = RR_upper_aft_i,
                                                                                                lower_fore_i = RR_lower_fore_i,
                                                                                                lower_aft_i = RR_lower_aft_i,
                                                                                                upper_o = RR_upper_o,
                                                                                                lower_o = RR_lower_o,
                                                                                                tie_i = RR_tie_i,
                                                                                                tie_o = RR_tie_o,
                                                                                                wheel_center = RR_wheel_center,
                                                                                                static_gamma = RR_static_gamma,
                                                                                                static_alpha = RR_static_alpha) annotation(
    Placement(transformation(origin = {70, -50}, extent = {{30, -30}, {-30, 30}})));
  // Tires
...
protected
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RL_upper_i_trans(r = (RL_upper_fore_i + RL_upper_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {-20, -30}, extent = {{10, -10}, {-10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RL_lower_i_trans(r = (RL_lower_fore_i + RL_lower_aft_i) / 2 - effective_center, animation = false) annotation(
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_upper_i_trans(r = (RR_upper_fore_i + RR_upper_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {20, -30}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation RR_lower_i_trans(r = (RR_lower_fore_i + RR_lower_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {20, -70}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(RR_cp, RR_tire.cp_frame) annotation(
    Line(points = {{120, -100}, {120, -80}, {130, -80}, {130, -60}, {130, -60}}));
  connect(axle_frame, RL_lower_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -70}, {-10, -70}}));
  connect(axle_frame, RR_lower_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -70}, {10, -70}}));
  ...
  connect(axle_frame, RR_tie_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -50}, {10, -50}}));
  connect(axle_frame, RL_upper_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -30}, {-10, -30}}));
  connect(axle_frame, RR_upper_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -30}, {10, -30}}));
  connect(RL_lower_i_trans.frame_b, RL_double_wishbone.lower_i_frame) annotation(
  ...
  connect(RL_upper_i_trans.frame_b, RL_double_wishbone.upper_i_frame) annotation(
    Line(points = {{-30, -30}, {-40, -30}}, color = {95, 95, 95}));
  connect(RR_upper_i_trans.frame_b, RR_double_wishbone.upper_i_frame) annotation(
    Line(points = {{30, -30}, {40, -30}}, color = {95, 95, 95}));
  connect(RR_tie_i_trans.frame_b, RR_double_wishbone.tie_i_frame) annotation(
    Line(points = {{30, -50}, {40, -50}}, color = {95, 95, 95}));
  connect(RR_lower_i_trans.frame_b, RR_double_wishbone.lower_i_frame) annotation(
    Line(points = {{30, -70}, {40, -70}}, color = {95, 95, 95}));
  connect(RL_double_wishbone.midpoint_frame, RL_tire.chassis_frame) annotation(
