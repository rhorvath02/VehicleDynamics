...
partial model FrRigidAxleBase
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.FrRigidDoubleWishbone FL_double_wishbone annotation(
    Placement(transformation(origin = {-70, -50}, extent = {{-30, -30}, {30, 30}})));
  VehicleDynamics.Vehicle.Chassis.Suspension.Templates.FrRigidDoubleWishbone FR_double_wishbone(upper_fore_i = FR_upper_fore_i,
                                                                                                upper_aft_i = FR_upper_aft_i,
                                                                                                lower_fore_i = FR_lower_fore_i,
                                                                                                lower_aft_i = FR_lower_aft_i,
                                                                                                upper_o = FR_upper_o,
                                                                                                lower_o = FR_lower_o,
                                                                                                tie_i = FR_tie_i,
                                                                                                tie_o = FR_tie_o,
                                                                                                wheel_center = FR_wheel_center,
                                                                                                static_gamma = FR_static_gamma,
                                                                                                static_alpha = FR_static_alpha) annotation(
    Placement(transformation(origin = {70, -50}, extent = {{30, -30}, {-30, 30}})));
  // Tires
...
protected
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation FL_upper_i_trans(r = (FL_upper_fore_i + FL_upper_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {-20, -30}, extent = {{10, -10}, {-10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation FL_lower_i_trans(r = (FL_lower_fore_i + FL_lower_aft_i) / 2 - effective_center, animation = false) annotation(
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation FR_upper_i_trans(r = (FR_upper_fore_i + FR_upper_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {20, -30}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation FR_lower_i_trans(r = (FR_lower_fore_i + FR_lower_aft_i) / 2 - effective_center, animation = false) annotation(
    Placement(transformation(origin = {20, -70}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(FR_cp, FR_tire.cp_frame) annotation(
    Line(points = {{120, -100}, {120, -80}, {130, -80}, {130, -60}, {130, -60}}));
  connect(axle_frame, FL_lower_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -70}, {-10, -70}}));
  connect(axle_frame, FR_lower_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -70}, {10, -70}}));
  ...
  connect(axle_frame, FR_tie_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -50}, {10, -50}}));
  connect(axle_frame, FL_upper_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -30}, {-10, -30}}));
  connect(axle_frame, FR_upper_i_trans.frame_a) annotation(
    Line(points = {{0, -100}, {0, -30}, {10, -30}}));
  connect(FL_lower_i_trans.frame_b, FL_double_wishbone.lower_i_frame) annotation(
  ...
  connect(FL_upper_i_trans.frame_b, FL_double_wishbone.upper_i_frame) annotation(
    Line(points = {{-30, -30}, {-40, -30}}, color = {95, 95, 95}));
  connect(FR_upper_i_trans.frame_b, FR_double_wishbone.upper_i_frame) annotation(
    Line(points = {{30, -30}, {40, -30}}, color = {95, 95, 95}));
  connect(FR_tie_i_trans.frame_b, FR_double_wishbone.tie_i_frame) annotation(
    Line(points = {{30, -50}, {40, -50}}, color = {95, 95, 95}));
  connect(FR_lower_i_trans.frame_b, FR_double_wishbone.lower_i_frame) annotation(
    Line(points = {{30, -70}, {40, -70}}, color = {95, 95, 95}));
  connect(FL_double_wishbone.midpoint_frame, FL_tire.chassis_frame) annotation(
