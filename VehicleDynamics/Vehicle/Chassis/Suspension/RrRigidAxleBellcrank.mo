...
model RrRigidAxleBellcrank
  ...
  extends VehicleDynamics.Vehicle.Chassis.Suspension.Templates.RrRigidAxleBase(RR_double_wishbone(side = "Right"));
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Linkages.Bellcrank3pu1p RL_bellcrank(pickup_1 = RL_bellcrank_pickup_1, pickup_2 = RL_bellcrank_pickup_2, pickup_3 = RL_bellcrank_pickup_3, pivot = RL_bellcrank_pivot, pivot_ref = RL_bellcrank_pivot_ref) annotation(
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Linkages.TabularSpring tabularSpring1(spring_table = [0, 0; 1, 70000], free_length = 10.5*0.0254, spring_diameter = 0.050) annotation(
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.Linkages.TabularDamper tabularDamper1(damper_table = [0, 0; 1, 1e3], free_length = 10.5*0.0254) annotation(
