...
parameter SIunits.Position RR_lower_aft_i[3] = {RL_lower_aft_i[1], -RL_lower_aft_i[2], RL_lower_aft_i[3]} annotation(Dialog(group="Geometry"));
  ...
  VehicleDynamics.Vehicle.Chassis.Body.FrameFrSteerFrRrBellcrank frameFrSteer(FL_upper_fore_i = FL_upper_fore_i, FL_upper_aft_i = FL_upper_aft_i, FL_tie_i = FL_tie_i, FL_lower_fore_i = FL_lower_fore_i, FL_lower_aft_i = FL_lower_aft_i, RL_upper_fore_i = RL_upper_fore_i, RL_upper_aft_i = RL_upper_aft_i, RL_tie_i = RL_tie_i, RL_lower_fore_i = RL_lower_fore_i, RL_lower_aft_i = RL_lower_aft_i, CG_location = CG_location, FL_mount = FL_mount_node, FR_mount = FR_mount_node, RL_mount = RL_mount_node, RR_mount = RR_mount_node, front_mass = 100, rear_mass = 100)  annotation(
    Placement(transformation(origin = {-8, 22}, extent = {{-30, -60}, {30, 60}})));
  ...
  Modelica.Mechanics.MultiBody.Joints.Prismatic free_z(n = {0, 0, 1}, s(start = 1, fixed = true)) annotation(
...
Modelica.Mechanics.MultiBody.Forces.SpringDamperParallel RR_rod(c = 62e3 / 10, s_unstretched = norm(RR_lower_o - RR_mount_node), d = 100e1) annotation(
  ...
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire tire1(FNOMIN = 654, LCX = 1, LCY = 1, LCZ = 1, LEX = 1, LEY = 1, LFZO = 1, LGAX = 1, LGAY = 1, LGAZ = 1, LGYR = 1, LHX = 1, LHY = 1, LIP = 1, LKX = 1, LKY = 1, LKYG = 1, LMUX = 1, LMUY = 1, LMX = 1, LMY = 1, LRES = 1, LS = 1, LSGAL = 1, LSGKP = 1, LTR = 1, LVMX = 1, LVX = 1, LVY = 1, LVYKA = 1, LXAL = 1, LYKA = 1, PCX1 = 1.65, PCY1 = 1.53041, PDX1 = 1, PDX2 = 0, PDX3 = 0, PDY1 = -2.40275, PDY2 = 0.343535, PDY3 = 3.89743, PEX1 = -0.5, PEX2 = 0, PEX3 = 0, PEX4 = 0, PEY1 = 0.00, PEY2 = -0.280762, PEY3 = 0.70403, PEY4 = -0.478297, PHX1 = 0, PHX2 = 0, PHY1 = 0.000000000, PHY2 = 0.000000000, PHY3 = 0.000000000, PKX1 = 12, PKX2 = 10, PKX3 = -0.6, PKY1 = -53.2421, PKY2 = 2.38205, PKY3 = 1.36502, PVX1 = 0, PVX2 = 0, PVY1 = 0.000000000, PVY2 = 0.000000000, PVY3 = 0.000000000, PVY4 = 0.000000000, QBZ1 = 8.22843, QBZ10 = -1.72926, QBZ2 = 2.98676, QBZ3 = -3.57739, QBZ4 = -0.429117, QBZ5 = 0.433125, QBZ9 = 0, QCZ1 = 1.41359, QDZ1 = 0.152526, QDZ2 = -0.0381101, QDZ3 = 0.387762, QDZ4 = -3.95699, QDZ6 = 0.00604966, QDZ7 = -0.000116241, QDZ8 = -2.33359, QDZ9 = -0.0379755, QEZ1 = -0.239731, QEZ2 = 1.29253, QEZ3 = -1.21298, QEZ4 = 0.197579, QEZ5 = 0.244, QHZ1 = -0.00101749, QHZ2 = 0.000378319, QHZ3 = -0.0405191, QHZ4 = 0.0185463, QSX1 = -0.0130807, QSX2 = 0.00, QSX3 = 0.0587803, QSY1 = 0, QSY2 = 0, QSY3 = 0, QSY4 = 0, R0 = 8*0.0254, RBX1 = 8.151136, RBX2 = 5.388063, RBY1 = 14.628, RBY2 = 10.400, RBY3 = -0.00441045, RCX1 = 1.122399, RCY1 = 1.044, REX1 = 0.052014, REX2 = -0.898450, REY1 = 0.048, REY2 = 0.025, RHX1 = 0.0, RHY1 = 0.009, RHY2 = 0.0023097, RVY1 = 4.78297e-06, RVY2 = 0.0127967, RVY3 = -0.498917, RVY4 = 18.2625, RVY5 = 2.72152, RVY6 = -10.5225, SSZ1 = 0, SSZ2 = 0, SSZ3 = 0, SSZ4 = 0, rim_R0 = 5*0.0254, rim_width = 7*0.0254, tire_c = 98947, tire_d = 115.844e4, wheel_J = 0.2, wheel_m = 8) annotation(
    Placement(transformation(origin = {-90, 10}, extent = {{10, -10}, {-10, 10}})));
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire tire11(FNOMIN = 654, LCX = 1, LCY = 1, LCZ = 1, LEX = 1, LEY = 1, LFZO = 1, LGAX = 1, LGAY = 1, LGAZ = 1, LGYR = 1, LHX = 1, LHY = 1, LIP = 1, LKX = 1, LKY = 1, LKYG = 1, LMUX = 1, LMUY = 1, LMX = 1, LMY = 1, LRES = 1, LS = 1, LSGAL = 1, LSGKP = 1, LTR = 1, LVMX = 1, LVX = 1, LVY = 1, LVYKA = 1, LXAL = 1, LYKA = 1, PCX1 = 1.65, PCY1 = 1.53041, PDX1 = 1, PDX2 = 0, PDX3 = 0, PDY1 = -2.40275, PDY2 = 0.343535, PDY3 = 3.89743, PEX1 = -0.5, PEX2 = 0, PEX3 = 0, PEX4 = 0, PEY1 = 0.00, PEY2 = -0.280762, PEY3 = 0.70403, PEY4 = -0.478297, PHX1 = 0, PHX2 = 0, PHY1 = 0.000000000, PHY2 = 0.000000000, PHY3 = 0.000000000, PKX1 = 12, PKX2 = 10, PKX3 = -0.6, PKY1 = -53.2421, PKY2 = 2.38205, PKY3 = 1.36502, PVX1 = 0, PVX2 = 0, PVY1 = 0.000000000, PVY2 = 0.000000000, PVY3 = 0.000000000, PVY4 = 0.000000000, QBZ1 = 8.22843, QBZ10 = -1.72926, QBZ2 = 2.98676, QBZ3 = -3.57739, QBZ4 = -0.429117, QBZ5 = 0.433125, QBZ9 = 0, QCZ1 = 1.41359, QDZ1 = 0.152526, QDZ2 = -0.0381101, QDZ3 = 0.387762, QDZ4 = -3.95699, QDZ6 = 0.00604966, QDZ7 = -0.000116241, QDZ8 = -2.33359, QDZ9 = -0.0379755, QEZ1 = -0.239731, QEZ2 = 1.29253, QEZ3 = -1.21298, QEZ4 = 0.197579, QEZ5 = 0.244, QHZ1 = -0.00101749, QHZ2 = 0.000378319, QHZ3 = -0.0405191, QHZ4 = 0.0185463, QSX1 = -0.0130807, QSX2 = 0.00, QSX3 = 0.0587803, QSY1 = 0, QSY2 = 0, QSY3 = 0, QSY4 = 0, R0 = 8*0.0254, RBX1 = 8.151136, RBX2 = 5.388063, RBY1 = 14.628, RBY2 = 10.400, RBY3 = -0.00441045, RCX1 = 1.122399, RCY1 = 1.044, REX1 = 0.052014, REX2 = -0.898450, REY1 = 0.048, REY2 = 0.025, RHX1 = 0.0, RHY1 = 0.009, RHY2 = 0.0023097, RVY1 = 4.78297e-06, RVY2 = 0.0127967, RVY3 = -0.498917, RVY4 = 18.2625, RVY5 = 2.72152, RVY6 = -10.5225, SSZ1 = 0, SSZ2 = 0, SSZ3 = 0, SSZ4 = 0, rim_R0 = 5*0.0254, rim_width = 7*0.0254, tire_c = 98947, tire_d = 115.844e4, wheel_J = 0.2, wheel_m = 8) annotation(
    Placement(transformation(origin = {90, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -0)));
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire tire12(FNOMIN = 654, LCX = 1, LCY = 1, LCZ = 1, LEX = 1, LEY = 1, LFZO = 1, LGAX = 1, LGAY = 1, LGAZ = 1, LGYR = 1, LHX = 1, LHY = 1, LIP = 1, LKX = 1, LKY = 1, LKYG = 1, LMUX = 1, LMUY = 1, LMX = 1, LMY = 1, LRES = 1, LS = 1, LSGAL = 1, LSGKP = 1, LTR = 1, LVMX = 1, LVX = 1, LVY = 1, LVYKA = 1, LXAL = 1, LYKA = 1, PCX1 = 1.65, PCY1 = 1.53041, PDX1 = 1, PDX2 = 0, PDX3 = 0, PDY1 = -2.40275, PDY2 = 0.343535, PDY3 = 3.89743, PEX1 = -0.5, PEX2 = 0, PEX3 = 0, PEX4 = 0, PEY1 = 0.00, PEY2 = -0.280762, PEY3 = 0.70403, PEY4 = -0.478297, PHX1 = 0, PHX2 = 0, PHY1 = 0.000000000, PHY2 = 0.000000000, PHY3 = 0.000000000, PKX1 = 12, PKX2 = 10, PKX3 = -0.6, PKY1 = -53.2421, PKY2 = 2.38205, PKY3 = 1.36502, PVX1 = 0, PVX2 = 0, PVY1 = 0.000000000, PVY2 = 0.000000000, PVY3 = 0.000000000, PVY4 = 0.000000000, QBZ1 = 8.22843, QBZ10 = -1.72926, QBZ2 = 2.98676, QBZ3 = -3.57739, QBZ4 = -0.429117, QBZ5 = 0.433125, QBZ9 = 0, QCZ1 = 1.41359, QDZ1 = 0.152526, QDZ2 = -0.0381101, QDZ3 = 0.387762, QDZ4 = -3.95699, QDZ6 = 0.00604966, QDZ7 = -0.000116241, QDZ8 = -2.33359, QDZ9 = -0.0379755, QEZ1 = -0.239731, QEZ2 = 1.29253, QEZ3 = -1.21298, QEZ4 = 0.197579, QEZ5 = 0.244, QHZ1 = -0.00101749, QHZ2 = 0.000378319, QHZ3 = -0.0405191, QHZ4 = 0.0185463, QSX1 = -0.0130807, QSX2 = 0.00, QSX3 = 0.0587803, QSY1 = 0, QSY2 = 0, QSY3 = 0, QSY4 = 0, R0 = 8*0.0254, RBX1 = 8.151136, RBX2 = 5.388063, RBY1 = 14.628, RBY2 = 10.400, RBY3 = -0.00441045, RCX1 = 1.122399, RCY1 = 1.044, REX1 = 0.052014, REX2 = -0.898450, REY1 = 0.048, REY2 = 0.025, RHX1 = 0.0, RHY1 = 0.009, RHY2 = 0.0023097, RVY1 = 4.78297e-06, RVY2 = 0.0127967, RVY3 = -0.498917, RVY4 = 18.2625, RVY5 = 2.72152, RVY6 = -10.5225, SSZ1 = 0, SSZ2 = 0, SSZ3 = 0, SSZ4 = 0, rim_R0 = 5*0.0254, rim_width = 7*0.0254, tire_c = 98947, tire_d = 115.844e4, wheel_J = 0.2, wheel_m = 8) annotation(
    Placement(transformation(origin = {-90, -50}, extent = {{10, -10}, {-10, 10}})));
  VehicleDynamics.Vehicle.Chassis.Tires.MF5p2Tire tire13(FNOMIN = 654, LCX = 1, LCY = 1, LCZ = 1, LEX = 1, LEY = 1, LFZO = 1, LGAX = 1, LGAY = 1, LGAZ = 1, LGYR = 1, LHX = 1, LHY = 1, LIP = 1, LKX = 1, LKY = 1, LKYG = 1, LMUX = 1, LMUY = 1, LMX = 1, LMY = 1, LRES = 1, LS = 1, LSGAL = 1, LSGKP = 1, LTR = 1, LVMX = 1, LVX = 1, LVY = 1, LVYKA = 1, LXAL = 1, LYKA = 1, PCX1 = 1.65, PCY1 = 1.53041, PDX1 = 1, PDX2 = 0, PDX3 = 0, PDY1 = -2.40275, PDY2 = 0.343535, PDY3 = 3.89743, PEX1 = -0.5, PEX2 = 0, PEX3 = 0, PEX4 = 0, PEY1 = 0.00, PEY2 = -0.280762, PEY3 = 0.70403, PEY4 = -0.478297, PHX1 = 0, PHX2 = 0, PHY1 = 0.000000000, PHY2 = 0.000000000, PHY3 = 0.000000000, PKX1 = 12, PKX2 = 10, PKX3 = -0.6, PKY1 = -53.2421, PKY2 = 2.38205, PKY3 = 1.36502, PVX1 = 0, PVX2 = 0, PVY1 = 0.000000000, PVY2 = 0.000000000, PVY3 = 0.000000000, PVY4 = 0.000000000, QBZ1 = 8.22843, QBZ10 = -1.72926, QBZ2 = 2.98676, QBZ3 = -3.57739, QBZ4 = -0.429117, QBZ5 = 0.433125, QBZ9 = 0, QCZ1 = 1.41359, QDZ1 = 0.152526, QDZ2 = -0.0381101, QDZ3 = 0.387762, QDZ4 = -3.95699, QDZ6 = 0.00604966, QDZ7 = -0.000116241, QDZ8 = -2.33359, QDZ9 = -0.0379755, QEZ1 = -0.239731, QEZ2 = 1.29253, QEZ3 = -1.21298, QEZ4 = 0.197579, QEZ5 = 0.244, QHZ1 = -0.00101749, QHZ2 = 0.000378319, QHZ3 = -0.0405191, QHZ4 = 0.0185463, QSX1 = -0.0130807, QSX2 = 0.00, QSX3 = 0.0587803, QSY1 = 0, QSY2 = 0, QSY3 = 0, QSY4 = 0, R0 = 8*0.0254, RBX1 = 8.151136, RBX2 = 5.388063, RBY1 = 14.628, RBY2 = 10.400, RBY3 = -0.00441045, RCX1 = 1.122399, RCY1 = 1.044, REX1 = 0.052014, REX2 = -0.898450, REY1 = 0.048, REY2 = 0.025, RHX1 = 0.0, RHY1 = 0.009, RHY2 = 0.0023097, RVY1 = 4.78297e-06, RVY2 = 0.0127967, RVY3 = -0.498917, RVY4 = 18.2625, RVY5 = 2.72152, RVY6 = -10.5225, SSZ1 = 0, SSZ2 = 0, SSZ3 = 0, SSZ4 = 0, rim_R0 = 5*0.0254, rim_width = 7*0.0254, tire_c = 98947, tire_d = 115.844e4, wheel_J = 0.2, wheel_m = 8) annotation(
    Placement(transformation(origin = {90, -50}, extent = {{-10, -10}, {10, 10}}, rotation = -0)));
  ...
  Modelica.Blocks.Sources.Constant const21(k = 0) annotation(
    Placement(transformation(origin = {-230, -60}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.Ramp ramp1(duration = 2, height = 385, startTime = 5) annotation(
    Placement(transformation(origin = {-230, -20}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(FL_rod.frame_b, frameFrSteer.FL_mount_frame) annotation(
    Line(points = {{-40, 70}, {-40, 72}, {-28, 72}}, color = {95, 95, 95}));
  connect(FR_rod.frame_b, frameFrSteer.FR_mount_frame) annotation(
    Line(points = {{40, 70}, {40, 72}, {12, 72}}, color = {95, 95, 95}));
  ...
  connect(RL_rod.frame_b, frameFrSteer.RL_mount_frame) annotation(
    Line(points = {{-24, -70}, {-24, -54}, {-28, -54}, {-28, -28}}, color = {95, 95, 95}));
  ...
  connect(RR_rod.frame_b, frameFrSteer.RR_mount_frame) annotation(
    Line(points = {{24, -70}, {24, -68}, {12, -68}, {12, -28}}, color = {95, 95, 95}));
  ...
  connect(free_x.frame_b, frameFrSteer.frame_a) annotation(
    Line(points = {{0, -20}, {0, -9}, {-8, -9}, {-8, 22}}, color = {95, 95, 95}));
  ...
  connect(fixed.frame_b, groundPhysics21.frame_a) annotation(
    Line(points = {{-150, 10}, {-140, 10}}, color = {95, 95, 95}));
  connect(tire1.chassis_frame, doubleWishboneBase.contact_patch_frame) annotation(
    Line(points = {{-80, 10}, {-60, 10}, {-60, 20}}, color = {95, 95, 95}));
  connect(groundPhysics21.frame_b, tire1.cp_frame) annotation(
    Line(points = {{-120, 10}, {-110, 10}, {-110, 0}, {-90, 0}}, color = {95, 95, 95}));
  connect(groundPhysics2.frame_b, tire12.cp_frame) annotation(
    Line(points = {{-120, -50}, {-110, -50}, {-110, -60}, {-90, -60}}, color = {95, 95, 95}));
  connect(tire12.chassis_frame, doubleWishboneBase1.contact_patch_frame) annotation(
    Line(points = {{-80, -50}, {-60, -50}, {-60, -40}}, color = {95, 95, 95}));
  connect(groundPhysics1.frame_b, tire11.cp_frame) annotation(
    Line(points = {{120, 10}, {110, 10}, {110, 0}, {90, 0}}, color = {95, 95, 95}));
  connect(tire11.chassis_frame, FR_doubleWishboneBase.contact_patch_frame) annotation(
    Line(points = {{80, 10}, {60, 10}, {60, 20}}, color = {95, 95, 95}));
  connect(groundPhysics3.frame_b, tire13.cp_frame) annotation(
    Line(points = {{120, -50}, {110, -50}, {110, -60}, {90, -60}}, color = {95, 95, 95}));
  connect(tire13.chassis_frame, RR_doubleWishboneBase1.contact_patch_frame) annotation(
    Line(points = {{80, -50}, {60, -50}, {60, -40}}, color = {95, 95, 95}));
  connect(const1.y, torque1.torque[1]) annotation(
    Line(points = {{-219, 20}, {-211, 20}, {-211, -20}, {-203, -20}}, color = {0, 0, 127}));
  connect(ramp1.y, torque1.torque[2]) annotation(
    Line(points = {{-219, -20}, {-203, -20}}, color = {0, 0, 127}));
  connect(const21.y, torque1.torque[3]) annotation(
    Line(points = {{-219, -60}, {-211, -60}, {-211, -20}, {-203, -20}}, color = {0, 0, 127}));
  connect(torque1.frame_b, tire12.hub_frame) annotation(
    Line(points = {{-180, -20}, {-100, -20}, {-100, -50}}, color = {95, 95, 95}));
  connect(const.y, torque.torque[1]) annotation(
    Line(points = {{199, 20}, {189, 20}, {189, -20}, {181, -20}}, color = {0, 0, 127}));
  connect(const2.y, torque.torque[3]) annotation(
    Line(points = {{199, -60}, {189, -60}, {189, -20}, {181, -20}}, color = {0, 0, 127}));
  connect(ramp2.y, torque.torque[2]) annotation(
    Line(points = {{199, -20}, {181, -20}}, color = {0, 0, 127}));
  connect(torque.frame_b, tire13.hub_frame) annotation(
    Line(points = {{160, -20}, {100, -20}, {100, -50}}, color = {95, 95, 95}));
  connect(wheel_body.frame_a, frameFrSteer.frame_a) annotation(
    Line(points = {{10, 0}, {5, 0}, {5, 22}, {-8, 22}}, color = {95, 95, 95}));
  annotation(
    uses(Modelica(version = "3.2.3")),
  Diagram(coordinateSystem(extent = {{-180, 100}, {180, -140}})),
  version = "",
  Documentation(revisions = "<html><head></head><body></body></html>"),
  experiment(StartTime = 0, StopTime = 7.5, Tolerance = 1e-06, Interval = 0.001));
end Test_Frame;