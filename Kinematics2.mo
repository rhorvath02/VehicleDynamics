model Kinematics2
  ...
  VehicleDynamics.Vehicle.Chassis.Suspension.DoubleWishboneBase doubleWishboneBase(upper_fore_i = upper_fore_i, upper_aft_i = upper_aft_i, lower_fore_i = lower_fore_i, lower_aft_i = lower_aft_i, upper_o = upper_o, lower_o = lower_o, tie_i = tie_i, tie_o = tie_o, contact_patch = contact_patch) annotation(
  ...
  VehicleDynamics.Utilities.Mechanics.Multibody.GroundPhysics groundPhysics annotation(
